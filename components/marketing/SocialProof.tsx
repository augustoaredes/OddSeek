const testimonials = [
  {
    ...
    text: 'Finalmente uma plataforma brasileira que calcula EV de verdade. Em 3 meses de uso o meu ROI saiu de -4% para +21%. O Kelly automático mudou minha disciplina completamente.',
    profit: '+R$4.820',
    period: '3 meses',
    sport: 'Futebol',
  },
  ...
  },
  {
    ...
    text: 'Comecei sem saber nada de Kelly ou EV. O OddSeek me ensinou apostando. O score de confiança ajuda demais a filtrar apostas mediocres. Hit rate subiu para 62%.',
    profit: '+R$1.890',
    period: '6 semanas',
    sport: 'MMA',
  },
