...
export const DEMO_BETS: BankBet[] = [
  ...
  { id:'b03', sport:'basketball', league:'NBA',               matchLabel:'Lakers vs Warriors',      market:'Vencedor',    selection:'Lakers',      book:'Pixbet',       odd:2.00, stake:30,  status:'lost',    profit:-30,  placedAt:d(28), settledAt:d(27), source:'manual' },
  ...
  { id:'b05', sport:'tennis',     league:'Roland Garros',     matchLabel:'Djokovic vs Medvedev',    market:'Vencedor',    selection:'Djokovic',    book:'Superbet',    odd:1.75, stake:50,  status:'won',     profit:37.5, placedAt:d(26), settledAt:d(25), source:'tip' },
  ...
  { id:'b08', sport:'basketball', league:'NBA',               matchLabel:'Celtics vs Heat',         market:'Total',       selection:'Over 218.5',  book:'Pixbet',       odd:1.92, stake:35,  status:'won',     profit:32.2, placedAt:d(23), settledAt:d(22), source:'tip' },
  ...
  { id:'b11', sport:'tennis',     league:'Wimbledon',         matchLabel:'Alcaraz vs Sinner',       market:'Vencedor',    selection:'Alcaraz',     book:'Superbet',    odd:1.82, stake:50,  status:'won',     profit:41,   placedAt:d(20), settledAt:d(19), source:'tip' },
  ...
  { id:'b13', sport:'mma',        league:'UFC 299',           matchLabel:"O'Malley vs Yan",        market:'Vencedor',    selection:"O'Malley",    book:'Pixbet',       odd:1.65, stake:60,  status:'won',     profit:39,   placedAt:d(18), settledAt:d(17), source:'tip' },
  ...
  { id:'b17', sport:'football',   league:'La Liga',           matchLabel:'Real Madrid vs Bilbao',   market:'Handicap',    selection:'RM -1',       book:'Superbet',    odd:2.08, stake:40,  status:'lost',    profit:-40,  placedAt:d(12), settledAt:d(11), source:'tip' },
  { id:'b18', sport:'tennis',     league:'US Open',           matchLabel:'Medvedev vs Fritz',       market:'Vencedor',    selection:'Medvedev',    book:'Pixbet',       odd:1.90, stake:35,  status:'won',     profit:31.5, placedAt:d(10), settledAt:d(9),  source:'tip' },
  ...
  { id:'b22', sport:'mma',        league:'UFC 300',           matchLabel:'Pereira vs Hill',         market:'Vencedor',    selection:'Pereira',     book:'Superbet',    odd:1.55, stake:70,  status:'won',     profit:38.5, placedAt:d(4),  settledAt:d(3),  source:'tip' },
  { id:'b23', sport:'football',   league:'Champions League',  matchLabel:'Man City vs Real Madrid', market:'Total',       selection:'Over 2.5',    book:'Pixbet',       odd:1.85, stake:50,  status:'lost',    profit:-50,  placedAt:d(3),  settledAt:d(2),  source:'manual' },
